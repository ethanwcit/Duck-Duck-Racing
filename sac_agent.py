...
class SACAgent:
    ...
    def train(self, batch_size=64):
        ...
        return {'actor': actor_loss.item(), 'critic': (critic1_loss.item() + critic2_loss.item()) / 2}, avg_q_value
    ...
    def save(self, filename, folder="saved_agents"):
        ...
        torch.save({
            ...
            'critic_optimizer1_state_dict': self.critic1_optimizer.state_dict(),
            'critic_optimizer2_state_dict': self.critic2_optimizer.state_dict()
